...
query = "select subjectidnumber,tasktypedone,story_prefs,reward_prefs,cost_prefs,reward_level,cost_level,decision_made,trial_start,trial_end,hunger,tired,pain,sex,age,trial_elapsed from" + table_name + ";"; % group by subjectidnumber having count(distinct tasktypedone) > 2";
