function varargout = spider_plot_mod1(P, options)
...
%     % Check if within min and max axes limits : DEACTIVATED FOR SPECIAL SPIDER PLOT with std 
...
%         % Check if the axes limits are within range of points : DEACTIVATED FOR SPECIAL SPIDER PLOT with std 
...
%     % Check if range is valid : DEACTIVATED FOR SPECIAL SPIDER PLOT with std 
%     if range == 0
