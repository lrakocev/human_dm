function plot_heatmap(summary_table,save_to,id_name)

heatmap(summary_table,'t1c1','t2c2','ColorVariable','dist_from_mean')
title('heatmap of std devs from mean of likelihood of y given x for ' + id_name)
xlabel("given task + cluster")
ylabel("task + cluster")
colormap('default')
savefig(save_to + id_name + "heatmap_of_stds.fig")

figure
heatmap(summary_table,'t1c1','t2c2','ColorVariable','sample_mean')
title('heatmap of mean values of likelihood of y given x for ' + id_name)
xlabel("given task + cluster")
ylabel("task + cluster")
colormap('default')
savefig(save_to + id_name + "heatmap_of_means.fig")
...
title('heatmap of (highlighted >1.5) std devs from mean of likelihood of y given x for ' + id_name)
xlabel("given task + cluster")
ylabel("task + cluster")
colormap('default')
savefig(save_to + id_name + "heatmap_of_stds_masked_1_5.fig")
