function bhatt_table = get_bhat_dist_heat_map_comparing_rat_to_human_2d(human_data_table,rat_data_table,normalize_or_dont,dir_to_save_figs_to,version_name,create_average_plot_or_dont,want_plot)
    function [bhat_distance_matrix_shift,bhat_distance_matrix_slope,heat_map_x_labels,heat_map_y_labels] = get_bhat_distance_matrix(human_data_table,rat_data_table,rat_clusters,human_clusters)
        ...
        for i=1:length(rat_clusters)
            ...
            for j=1:length(human_clusters)
                ...
                try 
                    ...
                    bhat_distance_matrix_shift(i,j) = dimensions_of_bhat_distance(1);
                    bhat_distance_matrix_slope(i,j) = dimensions_of_bhat_distance(2);
                catch
    ...
    function [] = create_heat_map(matrix_to_turn_into_heat_map,which_dimension,dir_to_save_figs_to,heat_map_x_labels,heat_map_y_labels,normalize_or_dont,version_name)
       figure;
        ...
        if which_dimension==1
            to_add_to_tile = "valuation";
        elseif which_dimension==2
            to_add_to_tile = "elasticity";
        elseif which_dimension == 0
            to_add_to_tile = "Average";
        end
...
[bhat_distance_matrix_shift,bhat_distance_matrix_slope,heat_map_x_labels,heat_map_y_labels] = get_bhat_distance_matrix(human_data_table,rat_data_table,rat_clusters,human_clusters);
...
if ~create_average_plot_or_dont
    ...
    average_matrix = (bhat_distance_matrix_shift+bhat_distance_matrix_slope) ./3;
