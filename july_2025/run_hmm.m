function [states, bic, mpcs, t, e] = run_hmm(seq_table, estimate_t, estimate_e)
...
[t, e, logliks] = hmmtrain(seqs, estimate_t, estimate_e, 'Symbols', symbols, 'MAXITERATIONS', 2000);
