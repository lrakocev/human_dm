function try_gaze_hmms(num_states)

home_dir = "";
filtered_behavior_table = prep_data_for_hmm(home_dir, "human_gaze_data.mat");
...
granularities = 2:5;
all_features = ["num_saccads", "num_guesses", "reaction_time"];
...
doc_num = 1;
excel_limit = 1000000;
file_name = "hmm_1d_gaze_data_states_" + string(num_states) + "_";
