...
num_clusters = max(all_psych_data.idx);
use_all = 1;
physio_tasks_anova(eye_merged, story_types, 0, use_all)
physio_tasks_anova(hr_merged, story_types, 1, use_all)

physio_clusters_anova(eye_merged, num_clusters, 0)
physio_clusters_anova(hr_merged, num_clusters, 1)