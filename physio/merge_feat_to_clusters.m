...
if use_cost
    merged_table = outerjoin(all_psych_data,new_table, 'MergeKeys',true, 'Keys',{'experiment','subjectidnumber','story_num','cost'});
else
    merged_table = outerjoin(all_psych_data,new_table, 'MergeKeys',true, 'Keys',{'experiment','subjectidnumber','story_num'});
end
